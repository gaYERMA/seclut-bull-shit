(function () {
        ...
        function JL(loggerName) {
            ...
            var Appender = function () {
                function Appender(appenderName, sendLogItems) {
                    ...
                    this.buffer = [];
                    this.batchBuffer = [];
                    this.batchTimeoutTimer = {
                        id: null
                    };
                    this.sendTimeoutTimer = {
                        id: null
                    };
    ...
    29: [function (require, module, exports) {
        ...
        "../OpenViduInternal/Events/ExceptionEvent": 45,
        "../OpenViduInternal/Logger/OpenViduLogger": 66,
        "./Stream": 36
    }],
    ...
    31: [function (require, module, exports) {
        ...
        "../OpenViduInternal/Enums/OpenViduError": 40,
        "../OpenViduInternal/Events/StreamPropertyChangedEvent": 54,
        "../OpenViduInternal/Logger/OpenViduLogger": 66
    }],
    32: [function (require, module, exports) {
        ...
        "../OpenViduInternal/Enums/LocalRecorderState": 39,
        "../OpenViduInternal/Logger/OpenViduLogger": 66,
        "../OpenViduInternal/Utils/Platform": 70
    }],
    33: [function (require, module, exports) {
        ...
        "../../package.json": 27,
        "../OpenViduInternal/Enums/OpenViduError": 40,
        "../OpenViduInternal/Enums/VideoInsertMode": 41,
        "../OpenViduInternal/Events/SessionDisconnectedEvent": 50,
        "../OpenViduInternal/Events/StreamPropertyChangedEvent": 54,
        "../OpenViduInternal/KurentoUtils/kurento-jsonrpc": 61,
        "../OpenViduInternal/Logger/OpenViduLogger": 66,
        "../OpenViduInternal/Logger/OpenViduLoggerConfiguration": 67,
        "../OpenViduInternal/ScreenSharing/Screen-Capturing": 69,
        "../OpenViduInternal/ScreenSharing/Screen-Capturing-Auto": 68,
        "../OpenViduInternal/Utils/Platform": 70,
        "./LocalRecorder": 32,
        "./Publisher": 34,
        "./Session": 35,
    ...
    34: [function (require, module, exports) {
        ...
        "../OpenViduInternal/Enums/OpenViduError": 40,
        "../OpenViduInternal/Events/StreamEvent": 52,
        "../OpenViduInternal/Events/StreamPropertyChangedEvent": 54,
        "../OpenViduInternal/Events/VideoElementEvent": 55,
        "../OpenViduInternal/Logger/OpenViduLogger": 66,
        "../OpenViduInternal/Utils/Platform": 70,
        "./Session": 35,
        "./Stream": 36,
    ...
    35: [function (require, module, exports) {
        ...
        var Session = function (_super) {
            ...
            Session.prototype.unpublish = function (publisher) {
                ...
                return new Promise((function (resolve, reject) {
                    ...
                    if (!stream.connection) {
                        ...
                        reject(new Error("The associated Connection object of this Publisher is not your local Connection." + "Only moderators can force unpublish on remote Streams via 'forceUnpublish' method"))
                    } else {
            ...
            Session.prototype.recvIceCandidate = function (event) {
                ...
                this.getConnection(event.senderConnectionId, "Connection not found for connectionId " + event.senderConnectionId + " owning endpoint " + event.endpointName + ". Ice candidate will be ignored: " + candidate).then((function (connection) {
                    var stream = connection.stream;
                    ...
                    _this.getRemoteConnection(event.connectionId, "onForciblyReconnectSubscriber").then((function (connection) {
                        if (!!connection.stream && connection.stream.streamId === event.streamId) {
                            ...
                            stream_1.completeWebRtcPeerReceive(true, true, event.sdpOffer).then((function () {
                                ...
                                return stream_1.finalRejectForSubscription(true, "Error while forcibly reconnecting remote stream " + event.streamId + ": " + error.toString(), reject)
                            }))
                        } else {
            ...
            Session.prototype.processJoinRoomResponse = function (opts) {
                ...
                if (opts.version !== this.openvidu.libraryVersion) {
                    logger.warn("OpenVidu Server (" + opts.version + ") and OpenVidu Browser (" + this.openvidu.libraryVersion + ") versions do NOT match. There may be incompatibilities")
                }
            };
            return Session
        ...
        "../OpenViduInternal/Enums/OpenViduError": 40,
        "../OpenViduInternal/Enums/VideoInsertMode": 41,
        "../OpenViduInternal/Events/ConnectionEvent": 42,
        "../OpenViduInternal/Events/ConnectionPropertyChangedEvent": 43,
        "../OpenViduInternal/Events/FilterEvent": 46,
        "../OpenViduInternal/Events/NetworkQualityLevelChangedEvent": 47,
        "../OpenViduInternal/Events/RecordingEvent": 49,
        "../OpenViduInternal/Events/SessionDisconnectedEvent": 50,
        "../OpenViduInternal/Events/SignalEvent": 51,
        "../OpenViduInternal/Events/StreamEvent": 52,
        "../OpenViduInternal/Events/StreamPropertyChangedEvent": 54,
        "../OpenViduInternal/Logger/OpenViduLogger": 66,
        "../OpenViduInternal/Utils/Platform": 70,
    ...
    36: [function (require, module, exports) {
        ...
        "../OpenViduInternal/Enums/OpenViduError": 40,
        "../OpenViduInternal/Events/ExceptionEvent": 45,
        "../OpenViduInternal/Events/PublisherSpeakingEvent": 48,
        "../OpenViduInternal/Events/StreamManagerEvent": 53,
        "../OpenViduInternal/Events/StreamPropertyChangedEvent": 54,
        "../OpenViduInternal/Logger/OpenViduLogger": 66,
        "../OpenViduInternal/Utils/Platform": 70,
        "../OpenViduInternal/WebRtcPeer/WebRtcPeer": 71,
        "../OpenViduInternal/WebRtcStats/WebRtcStats": 72,
        "./Filter": 31,
        "./Subscriber": 38,
        hark: 5,
        "wolfy87-eventemitter": 26
    ...
    58: [function (require, module, exports) {
        ...
        "../": 61,
        "../../../Logger/OpenViduLogger": 66,
        "./transports/webSocketWithReconnection": 60
    }],
    59: [function (require, module, exports) {
        var WebSocketWithReconnection = require("./webSocketWithReconnection");
        exports.WebSocketWithReconnection = WebSocketWithReconnection
    }, {
        "./webSocketWithReconnection": 60
    }],
    ...
    61: [function (require, module, exports) {
        ...
        function RpcBuilder(packer, options, transport, onRequest) {
            ...
            else Object.defineProperty(this, "peerID", {
    ...
    65: [function (require, module, exports) {
        ...
        var ConsoleLogger = function () {
            function ConsoleLogger(console) {
                this.logger = console;
                this.log = window.console.log, this.info = window.console.info, this.debug = window.console.debug, this.warn = window.console.warn, this.error = window.console.error
            }
    ...
    66: [function (require, module, exports) {
        ...
        var OpenViduLogger = function () {
            ...
            OpenViduLogger.configureJSNLog = function (openVidu, token) {
                var _this = this;
                try {
                    if (window["LOG_JSNLOG_RESULTS"] || this.instance && openVidu.isPro && this.instance.isOpenViduBrowserLogsDebugActive(openVidu) && this.instance.canConfigureJSNLog(openVidu, this.instance)) {
        ...
        "./ConsoleLogger": 65,
        "./OpenViduLoggerConfiguration": 67,
        jsnlog: 7
    }],
                        ...
                        return __generator(this, (function (_d) {
                            switch (_d.label) {
                                ...
                                case 1:
                                    ...
                                    if (!(!("encodings" in sendParams) || sendParams.encodings.length !== tcInit.sendEncodings.length)) return [3, 3];
                                ...
                                case 5:
                                    ...
                                    _d.label = 6;
                                case 6:
                                    this.pc.createOffer().then((function (sdpOffer) {
                                        return resolve(sdpOffer)
                                    })).catch((function (error) {
                                        return reject(error)
                                    }));
                                    return [3, 8];
                                case 7:
                                    ...
                                    this.pc.createOffer(options).then((function (sdpOffer) {
                                        return resolve(sdpOffer)
                                    })).catch((function (error) {
                                        return reject(error)
                                    }));
