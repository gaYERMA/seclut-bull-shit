function ENCRYPT(e) {
  ...
  for (b.push(r); b.length % 16 != 14; ) b.push(0);
  for (
    b.push(v >>> 29), b.push((v << 3) & 4294967295), o = 0;
    o < b.length;
    o += 16
  ) {
    for (r = 0; r < 16; r++) f[r] = b[o + r];
    for (r = 16; r <= 79; r++)
      f[r] = t(f[r - 3] ^ f[r - 8] ^ f[r - 14] ^ f[r - 16], 1);
    for (s = h, a = w, c = g, l = p, d = m, r = 0; r <= 19; r++)
      (u =
        (t(s, 5) + ((a & c) | (~a & l)) + d + f[r] + 1518500249) & 4294967295),
        (d = l),
        (l = c),
        (c = t(a, 30)),
        (a = s),
        (s = u);
    for (r = 20; r <= 39; r++)
      (u = (t(s, 5) + (a ^ c ^ l) + d + f[r] + 1859775393) & 4294967295),
        (d = l),
        (l = c),
        (c = t(a, 30)),
        (a = s),
    ...
    for (r = 40; r <= 59; r++)
      (u =
        (t(s, 5) + ((a & c) | (a & l) | (c & l)) + d + f[r] + 2400959708) &
        4294967295),
        (d = l),
        (l = c),
        (c = t(a, 30)),
        ...
        (s = u);
    for (r = 60; r <= 79; r++)
      (u = (t(s, 5) + (a ^ c ^ l) + d + f[r] + 3395469782) & 4294967295),
        (d = l),
        (l = c),
        (c = t(a, 30)),
        (a = s),
...
function fetchClusterUrl() {
  var e = window.userEmail.split("@")[1],
    t = createBlockingRequest(
      "get",
      checkClusterURL +
        "/crextn/cluster?domain=" +
        e +
        "&reasonCode=" +
        window.clusterFound
    ),
  ...
  if (n && 2 == (n = n.split(",")).length) {
    var o;
    if (
      (o = new Date().getTime() / 1e3 - n[1]) < 31536e3 &&
      "UNKNOWN_SCHOOL" != n[0] &&
      "unknown" != window.ClusterUrl
    )
      return (
        (window.clusterUrl = n[0]),
        (window.clusterFound = window.clusterStatus.FOUND),
        "UNKNOWN_SCHOOL" !== window.clusterUrl &&
        "AVOID_OS" !== window.clusterUrl &&
        "unknown" !== window.clusterUrl
          ? (1 == window.needToReloadTabs &&
              ((window.needToReloadTabs = 0), checkAllLoadedTabs()),
            latencyCheck())
          : "AVOID_OS" == window.clusterUrl &&
    ...
    if (
      o < 3600 &&
      ("UNKNOWN_SCHOOL" == n[0] || "unknown" == window.ClusterUrl)
    )
      return (
        (window.clusterUrl = n[0]),
        void (
  ...
  t.onreadystatechange = function () {
    if (4 == t.readyState && 200 == t.status) {
      ...
      (window.debugIWF = 0),
        -1 !== e.lastIndexOf("_disableIWF")
          ? ((window.clusterUrl = e.slice(0, e.lastIndexOf("_disableIWF"))),
            (window.debugIWF = 1),
            localStorage.clear())
          : -1 !== e.lastIndexOf("_updateIWF")
          ...
          : ((window.clusterUrl = e),
            localStorage.setItem(
              "cluster",
              window.clusterUrl + "," + new Date().getTime() / 1e3
            )),
        (window.clusterFound = window.clusterStatus.FOUND),
        setupIWF(),
        getGeolocationStatus(),
...
function fetchDNS() {
  ...
  var e = createBlockingRequest(
    "get",
    "https://dns.google.com/resolve?name=" + domainCheck + "&type=A"
  );
...
function fetchUserAPI() {
  chrome.identity.getProfileUserInfo(function (e) {
    var t = e.email;
    !0 === forceUserEmail && (t = DEBUG_userEmail),
      "" !== t
        ? ((window.userEmail = t),
...
function skipCacheAndLogAlways(e, t) {
  return -1 != e.indexOf("twitter.com")
    ? 1
    : -1 != e.indexOf("facebook.com")
    ? 1
    : -1 != e.indexOf("google.co") &&
      -1 == e.indexOf("mail.google.co") &&
      -1 == e.indexOf("drive.google.co")
    ? 1
    : -1 != e.indexOf("bing.co")
    ? 1
    : -1 != e.indexOf("search.yahoo.co")
    ? 1
    : -1 != e.indexOf("wikipedia.org")
    ? 1
    : -1 != e.indexOf("youtube.co")
    ? 1
    : 0;
}
  ...
  return new Promise(function (n, o) {
    chrome.tabs.get(e, function (e) {
      if (e && "loading" == e.status) {
        ...
        if (
          void 0 !== e.pendingUrl &&
          (-1 != (o = new URL(e.pendingUrl).hostname).indexOf("securly.com") ||
            -1 != o.indexOf("iheobagjkfklnlikgihanlhcddjoihkg"))
        )
          return void n(!0);
      }
...
function interceptOrNot(e) {
  ...
  if (null !== localStorage.getItem(c))
    return takeDenyActionTabs("G", "BL", "", window.btoa(s), e.tabId), (t = 0);
  if (window.failedOpenObj && window.failedOpenObj.isFailedOpen()) {
    if (window.failedOpenObj.isWideOpenMode()) t = 0;
      ...
      null == d ||
        ("main_frame" != n && "sub_frame" != n) ||
        takeToFailedOpenBlockedPage(e.tabId, r, d);
    }
    return t;
  }
  if (
    (-1 == o.indexOf("youtube.com") && (o = o.toLowerCase()),
    -1 != r.indexOf("google.co") &&
      -1 != i.indexOf("/maps/") &&
      -1 != i.indexOf("/place/"))
  )
    return (t = 1);
  ...
  return -1 != r.indexOf("twitter.com") &&
    (-1 != i.indexOf(window.twitterMessageURI) ||
      (-1 != i.indexOf("api/graphql") && -1 != i.indexOf("CreateTweet")) ||
      (-1 != o.indexOf(window.twitterPrefetchTimestamp) && -1 == e.tabId)) &&
    "xmlhttprequest" == n
    ? (t = 1)
    : !r.indexOf("facebook.com") ||
      (-1 == i.indexOf("updatestatus") &&
        -1 == i.indexOf("webgraphql") &&
        -1 == i.indexOf("api/graphql")) ||
      "xmlhttprequest" != n
    ? -1 != r.indexOf("google.co") &&
      -1 != i.indexOf("/plusappui/mutate") &&
      "xmlhttprequest" == n
      ? (t = 1)
      : -1 != r.indexOf("google.co")
      ? ((t = 0),
        "xmlhttprequest" != n && "main_frame" != n
          ? (t = 0)
          : -1 != r.indexOf("accounts.google.co") ||
            -1 != r.indexOf("docs.google.co") ||
            -1 != i.indexOf("/calendar/") ||
            -1 != r.indexOf("code.google.co") ||
            -1 != i.indexOf("/cloudprint") ||
            -1 != i.indexOf("/_/chrome/newtab") ||
            -1 != r.indexOf("appengine.google.com") ||
            -1 != i.indexOf("/complete/search") ||
            -1 != i.indexOf("/webhp")
          ? (t = 0)
          : -1 != r.indexOf("meet.google.co")
          ? (t = 1)
          : -1 != i.indexOf("/search") ||
            -1 != i.indexOf("/#q") ||
            -1 != r.indexOf("translate.google.co") ||
            -1 != r.indexOf("remotedesktop.google.co")
          ? (t = 1)
          : -1 != r.indexOf("mail.google.co") && "main_frame" == n
          ? (t = 1)
          : -1 != r.indexOf("drive.google.co") && "main_frame" == n
          ? (t = 1)
          : -1 != r.indexOf("sites.google.co") && "main_frame" == n
          ? (t = 1)
          : -1 != r.indexOf("hangouts.google.co") && "main_frame" == n
          ? (t = 1)
          : -1 != r.indexOf("plus.google.co") && "main_frame" == n
          ? (t = 1)
          : 0)
      : -1 != r.indexOf("youtube.com") && "main_frame" == n
      ? (t = 1)
      : -1 != r.indexOf("youtube.com") &&
        "sub_frame" == n &&
        -1 != i.indexOf("embed")
      ? (t = 1)
      : -1 == r.indexOf("youtube.com") ||
        (-1 == i.indexOf("watch_fragments_ajax") &&
          -1 == i.indexOf("doubleclick/DARTIframe.html") &&
          -1 == i.indexOf("ad_data_204") &&
          -1 == i.indexOf("annotations_invideo") &&
          -1 == i.indexOf("api/stats/atr") &&
          -1 == i.indexOf("get_video_info"))
      ? -1 != i.indexOf("youtubei/v1/search") ||
        -1 != i.indexOf("youtube.com/results")
        ? 1
        : ("main_frame" != n && "sub_frame" != n) ||
          -1 == r.indexOf("youtube.com")
        ? -1 != r.indexOf("facebook.com") && "sub_frame" == n
          ? (t = 0)
          : (-1 != r.indexOf("bing.com") && -1 != i.indexOf("/fd/fb")) ||
            -1 != r.indexOf("ssl.bing.com") ||
            -1 != i.indexOf("/passport.aspx")
          ? (t = 0)
          : -1 != r.indexOf("bing.com") && "sub_frame" === n
          ? (t = 1)
          : "main_frame" == n || ("sub_frame" == n && 1 == window.checkiFrames)
          ? (t = 1)
          : t
        : -1 != i.indexOf("youtubei/v1/search")
        ? 1
        : "/" == i
        ? 1
        : -1 == i.indexOf("/results") && -1 == i.indexOf("/watch")
        ? 0
        : -1 != o.indexOf("pbj=1")
        ? 0
        : (t = 1)
...
function getBlockUrl(e, t, n, o, r) {
  ...
  if (
    ...
    ("BL" != t && "BL_SRCH" != t) ||
      ((i = "G" == e ? "globalblacklist" : "policyblacklist"), (t = "BL")),
    ("WL" != t && "WL_SRCH" != t) || ((i = "whitelistonly"), (t = "WL")),
    "BANNED" == t && (i = "banned"),
    "unknown" != window.clusterUrl)
  ) {
    var c = window.atob(o),
    ...
    return (
      (d =
        window.clusterUrl.replace("/crextn", "") +
        "/blocked?useremail=" +
        window.userEmail +
        "&reason=" +
        i +
...
function takeDenyActionTabs(e, t, n, o, r, i, s) {
  ...
  var l = "";
  if (
    (("BL" != t && "BL_SRCH" != t && "WL" != t && "WL_SRCH" != t) || (l = t),
    ("BL" != t && "BL_SRCH" != t) ||
      ((a = "G" == e ? "globalblacklist" : "policyblacklist"), (t = "BL")),
    "BANNED" == t && (a = "banned"),
    ...
    return (
      ...
      l && (w += "&listType=" + l),
      void 0 !== s && s && (w += "&rebroker=1"),
      void isBlockingInProgress(r, "http://" + window.atob(o))
        .then(function (e) {
...
function setBlockedPage(e, t) {
  -1 == e && (e = null),
    ...
    chrome.tabs.update(e, { url: t }, function () {
      chrome.runtime.lastError &&
        (console.log(
          "some error while redirecting to blocked page",
          chrome.runtime.lastError
        ),
        setTimeout(function () {
...
function takeDenyAction(e, t, n) {
  ...
  if ("0" == e && "-1" == t) return { cancel: !0 };
  var r = "";
  if (
    (("BL" != t && "BL_SRCH" != t && "WL" != t && "WL_SRCH" != t) || (r = t),
    ("BL" != t && "BL_SRCH" != t) ||
      ((o = "G" == e ? "globalblacklist" : "policyblacklist"), (t = "BL")),
    "BANNED" == t && (o = "banned"),
    "unknown" == window.clusterUrl)
  )
    return { cancel: !0 };
  ...
  var a =
    ...
    "&ver=" +
    window.version +
    (1 == window.isSubFrame ? "&subFrame=1" : "");
  return (
    window.geoLat &&
      window.geoLng &&
...
function takeSafeSearchAction(e, t) {
  return -1 != e.indexOf("google.co") && /q=/.test(t)
    ? -1 === t.indexOf("safe=") && t + "&safe=strict"
    : -1 != e.indexOf("bing.com") && -1 == t.indexOf("adlt=strict")
    ? -1 != t.indexOf("?")
      ? t + "&adlt=strict"
      : t + "?adlt=strict"
    : -1 != e.indexOf("search.yahoo.com") && -1 == t.indexOf("vm=r")
    ? -1 != t.indexOf("?")
      ? t + "&vm=r"
      : t + "?vm=r"
    : t;
...
function takeCreativeCommonImageSearchAction(e) {
  ...
  if (
    -1 != e.indexOf("bing.com/images/search") &&
    -1 == e.toLowerCase().indexOf("&qft=+filterui:licensetype-any")
  )
    return e + "&qft=+filterui:licenseType-Any";
  return -1 != e.indexOf("search.yahoo.com/search/images") &&
    -1 == e.indexOf("&imgl=fmsuc")
    ? e + "&imgl=fmsuc"
    : e;
}
function getYtSSRequestHeaders(e, t) {
  if (
    ...
    if ("" == n) t.push({ name: "Cookie", value: "PREF=f2=8000000" });
    else {
      var r = 0,
        i = n.split("; ");
      for (o = 0; o < i.length; ++o)
        -1 != i[o].indexOf("PREF") &&
          (-1 == i[o].indexOf("f2=8000000") && (i[o] += "&f2=8000000"),
          (r = 1)),
          -1 != i[o].indexOf("SID=") && (i[o] = "");
      0 == r && i.push("PREF=f2=8000000");
      var s = "";
      for (o = 0; o < i.length; ++o) (s += i[o]), (s += "; ");
      (s = s.substring(0, s.length - 2)), t.push({ name: "Cookie", value: s });
    }
  }
  return t;
}
...
function invalidateSkipListCaching(e, t) {
  ...
  if (t)
    ...
    for (o = 0; o < n.length; o++) {
      if (-1 != n[o].indexOf("*"))
        window.skipList[n[o]].regx.test(cleanURL(url)) &&
          (window.skipList[n[o]].last_broker_call = 0);
    }
  }
}
function setupOrReload() {
  ...
  window.clusterFound == window.clusterStatus.FOUND
    ...
    ? ((window.needToReloadTabs = 1),
      ...
      sessionStorage.clear())
    : (console.log(
        "https://www.securly.com/crextn/blocked?useremail=" +
          window.userEmail +
          "&reason=notregistered&cu=" +
          window.clusterUrl +
          "&uf=" +
          window.userFound +
          "&cf=" +
...
function getGeolocationStatus() {
  if (
    ...
    var e = createBlockingRequest(
      "get",
      window.clusterUrl + "/getGeoStatus?userEmail=" + window.userEmail
    );
    e.onload = function () {
      (window.geolocation = parseInt(e.responseText.trim())),
        window.geolocation &&
          (getGeolocation(),
          null != window.geoIntervalId && clearInterval(window.geoIntervalId),
...
function getRemoteIPGeo() {
  if ("unknown" != window.clusterUrl) {
    var e = createBlockingRequest(
      "get",
      window.clusterUrl + "/getGeoStatus?ip=1"
    );
    e.onload = function () {
      e.responseText.trim() != window.geoLastIP &&
        (getGeolocation(), (window.geoLastIP = e.responseText.trim()));
    };
    try {
      e.send();
    } catch (e) {
...
function getQueryVariable(e, t) {
  ...
  n.href = e;
  for (
    var o = n.search.replace(/\?/, "").split("&"), r = 0;
    r < o.length;
    r++
  ) {
    var i = o[r].split("=");
...
function extractTranslateHostname(e) {
  ...
  if ("" != n) {
    var o = (n = (n = (n = (n = decodeURIComponent(n)).toLowerCase()).replace(
      "http://",
      ""
    )).replace("https://", "")).indexOf("/");
  ...
  (window.needToReloadTabs = 0),
    chrome.tabs.query({}, function (e) {
      for (var t = 0; t < e.length; t++)
        -1 == e[t].url.indexOf("securly.com") &&
          ((-1 == e[t].url.indexOf("http://") &&
            -1 == e[t].url.indexOf("https://")) ||
...
function getDebugInfo() {
  var e = { clusterUrl: window.clusterUrl, userEmail: window.userEmail },
    t = createBlockingRequest(
      "get",
      window.clusterUrl.replace("crextn", "app/session")
    );
  (t.onerror = function () {
...
function selfClusterCheckBeforeBroker() {
  ("unknown" === window.clusterUrl ||
    (window.clusterFound !== window.clusterStatus.FOUND &&
      window.clusterFound !== window.clusterStatus.AVOID_OS)) &&
    ((window.needToReloadTabs = 0), fetchClusterUrl());
}
function downloadIWFList() {
  localStorage.clear();
  var e = createNonBlockingRequest(
    "get",
    "http://cdn1.securly.com/iwf-encode.txt"
  );
  (e.onreadystatechange = function () {
    if (4 == e.readyState)
      if (200 == e.status) {
...
function downloadNonCIPA() {
  var e = createNonBlockingRequest(
    "get",
    "http://cdn1.securly.com/non-cipa-encode.txt"
  );
  (e.onreadystatechange = function () {
    if (4 == e.readyState)
      if (200 == e.status) {
...
function setupIWF() {
  ...
  isNaN(t)
    ? isNaN(t) &&
      0 === window.debugIWF &&
      (downloadIWFList(), downloadNonCIPA())
    : e - t >= window.IWFTimeout && (downloadIWFList(), downloadNonCIPA());
}
...
function myB64EncodeHelper(e, t) {
  ...
  return (
    "0" <= e && e <= "9"
      ? (n += t %= 10) > "9".charCodeAt(0) && (n -= 10)
      : "A" <= e && e <= "Z"
      ? (n += t %= 26) > "Z".charCodeAt(0) && (n -= 26)
      : "a" <= e && e <= "z" && (n += t %= 26) > "z".charCodeAt(0) && (n -= 26),
...
function setClassroomCookies() {
  chrome.cookies.getAll(
    { domain: "securly.com", name: "live_session" },
    function (e) {
      e && e.length > 0
    ...
    chrome.cookies.getAll(
      { domain: "securly.com", name: "classroom_enabled" },
      function (e) {
        e && e.length > 0
...
function setClearCacheCookie(e) {
  ...
  chrome.cookies.getAll(
    { domain: t, name: "crextn_clear_cache_at" },
    function (t) {
      if (t && t.length > 0) {
        var n = getCookies();
        setCookie("crextn_clear_cache_at", t[0].value),
          console.debug(
            "[setClearCacheCookie]",
            "crextn_clear_cache_at cookie updated",
            t[0].value
          ),
          void 0 !== n.crextn_clear_cache_at &&
            n.crextn_clear_cache_at != decodeURIComponent(t[0].value) &&
            (console.debug(
              "[setClearCacheCookie]",
              "session cleared and rebrokering loaded tabs"
            ),
            sessionStorage.clear(),
...
function clearCacheIfTTLExpired() {
  var e = getCookies();
  void 0 !== e.crextn_clear_cache_at
    ? new Date().getTime() >= new Date(e.crextn_clear_cache_at).getTime() &&
      (console.debug("[clearCacheIfTTLExpired]", "session cleared"),
      sessionStorage.clear())
    : console.debug(
        "[clearCacheIfTTLExpired]",
        "crextn_clear_cache_at cookie not found"
      );
}
  ...
  (e = void 0 === e ? "" : e),
    chrome.tabs.query({}, function (t) {
      for (var n = 0; n < t.length; n++)
        t[n].id != e &&
          -1 == t[n].url.indexOf("securly.com") &&
          ((-1 == t[n].url.indexOf("http://") &&
            -1 == t[n].url.indexOf("https://")) ||
            ((t[n].initiator = ""),
            (t[n].type = "main_frame"),
            (t[n].method = "GET"),
            (t[n].tabId = t[n].id),
            onBeforeRequestListener(t[n], !0)));
    });
}
function doBrokerForClassroom() {
  ...
  if (1 == e.classroom_enabled && void 0 !== e.classroom_enabled) {
    ...
    return void 0 !== e.last_broker_call
      ? t - e.last_broker_call > 300
      : (setCookie("last_broker_call", t, 5), !0);
  }
  return !1;
}
function latencyPing() {
  var e = Date.now(),
    t = createNonBlockingRequest(
      "get",
      "https://" + window.latencyAPI + "/ping"
    );
  (t.onreadystatechange = function () {
    if (4 == t.readyState && 200 == t.status) {
      var n = Date.now() - e;
...
function latencyCheck() {
  ...
  if (null == e || Math.floor(Date.now() / 1e3) - e >= 86400) {
    var t = createNonBlockingRequest(
      "get",
      window.clusterUrl + "/internetQualityFeed?userEmail=" + window.userEmail
    );
    (t.onreadystatechange = function () {
      if (4 == t.readyState)
        if (200 == t.status) {
            ...
            ? ((window.fid = e.fid),
              ...
              null === window.latencyInterval &&
                (window.latencyInterval = setInterval(function () {
                  latencyPing();
                }, Math.floor(60 * window.latencyFrequency * 1e3))))
            : null !== window.latencyInterval &&
              (clearInterval(window.latencyInterval),
              (window.latencyInterval = null)),
            localStorage.setItem(
...
function downloadConfig() {
  var e = createNonBlockingRequest(
    "get",
    "http://cdn1.securly.com/config.json"
  );
  (e.onreadystatechange = function () {
      ...
      if (t.skiplist) {
        ...
        t.skiplist.forEach(function (e) {
          ...
          if (void 0 !== t && t.trim().length > 0) {
            if (
              ((n[t] = { ttl: e[t], last_broker_call: 0 }),
              -1 != t.indexOf("*"))
            ) {
              var o = t
                  .replaceAll(".", "\\.")
...
function updateTTLForCrextnCacheConfig(e) {
  void 0 !== window.cacheIntervalId && clearInterval(window.cacheIntervalId),
...
function isSeachRequest(e, t) {
  return (
    (-1 != e.indexOf("google.co") && -1 != t.indexOf("/search")) ||
    (-1 != e.indexOf("bing.com") && -1 != t.indexOf("/search")) ||
    (-1 != e.indexOf("search.yahoo.com") && -1 != t.indexOf("/search"))
  );
}
...
function sendSocialPostToServer(e, t, n, o) {
  if (
    ...
    o =
      window.clusterUrl +
      "/socialActivity?msg=" +
      window.btoa(encodeURIComponent(e)) +
      "&domain=" +
      window.btoa(t) +
      "&context=" +
      window.btoa(n) +
...
function decryptPhrases(e) {
  ...
  return (
    e.forEach(function (e) {
      let n = CryptoJS.AES.decrypt(e, window.thinkTwicePassPhrase).toString(
        CryptoJS.enc.Utf8
      );
...
function getSocialPost(e, t) {
  var n = "",
    o = "";
  if (
    -1 != e.url.indexOf("twitter.com") &&
    (-1 != e.url.indexOf(window.twitterMessageURI) ||
      (-1 != e.url.indexOf("api/graphql") &&
        -1 != e.url.indexOf("CreateTweet"))) &&
    "POST" == e.method &&
    "xmlhttprequest" == e.type
  ) {
    var r = "";
    void 0 !== e.requestBody.raw
      ? ("" ==
          (r = extractTweet(
  ...
  -1 == t.indexOf("facebook.com") ||
    (-1 == t.indexOf("updatestatus") && -1 == t.indexOf("webgraphql")) ||
    "POST" != e.method ||
    "xmlhttprequest" != e.type ||
    ((o = buff2StrWithEmoji(e.requestBody.raw[0].bytes)),
  ...
  if (
    -1 != t.indexOf("google.co") &&
    -1 != t.indexOf("/PlusAppUi/mutate") &&
    "POST" == e.method &&
    "xmlhttprequest" == e.type
  ) {
    var s = "";
...
function extractTweet(e) {
  ...
  return t.variables &&
    ...
    t.variables.tweet_text &&
    t.variables.tweet_text.length > 0
    ? t.variables.tweet_text
    : "";
}
  ...
  if ((doBrokerForClassroom() && (d = ""), d))
    if (-1 != d.indexOf("ALLOW") && 0 == skipCacheAndLogAlways(e, o));
      ...
      if (
        ...
        null != c && ((h = c.channelId), (a = c.videoId), (w = c.category)),
        (u =
          window.clusterUrl +
          "/broker?useremail=" +
          window.userEmail +
        ...
        l && (u += "&rebroker=1"),
        0 == d.indexOf("SS") &&
          stripSafeSearchPramas(o) == window.lastBrokeredRequest)
      )
        return d.split(":");
      (window.lastBrokeredRequest = o),
        ...
        (f.onload = function () {
          if (
            ((void 0 !== l && l) || setClearCacheCookie(r),
            0 != (d = f.responseText.trim()).indexOf("FAILED_OPEN:"))
          ) {
            if (-1 == d.toLowerCase().indexOf("<html")) {
              ...
              if ("DENY" != o && "PAUSE" != o)
                ...
                "DENY" == o
                  ...
                  : "PAUSE" == o && takePauseActionTabs(t, r);
            }
          } else {
            var g = d.split(":");
    ...
    if (
      (selfClusterCheckBeforeBroker(),
      null != c && ((w = c.channelId), (h = c.videoId), (g = c.category)),
      (u =
        window.clusterUrl +
        "/broker?useremail=" +
        window.userEmail +
      ...
      (f.onload = function () {
        if (0 != (d = f.responseText.trim()).indexOf("FAILED_OPEN:")) {
          ...
          if (0 == isNaN(n) && n >= 0) {
            ...
            Long.fromNumber(c).and(Math.pow(2, 36)).shiftRight(0).toNumber() ==
              u && (o = !0);
          }
          if (
            ((void 0 !== l && l) || setClearCacheCookie(r),
            setClassroomCookies(),
            -1 == d.indexOf("DENY") && -1 == d.indexOf("PAUSE"))
          )
            try {
              putURLCache(d, t, e, o),
                setCookie("last_broker_call", Math.floor(Date.now() / 1e3), 5);
            } catch (e) {
              sessionStorage.clear();
            }
            ...
            var h = d.split(":"),
              ...
              p = h[3];
            h[4], h[5], h[6];
            0 == s || 0 == window.checkiFrames
              ? ((window.isSubFrame = !1),
                (isSubFrame = !1),
                takeDenyActionTabs(w, g, p, t, r, isSubFrame, l))
              : 1 == window.checkiFrames &&
                ((a.iframeResp = h),
                "" !== i && window.atob(t) !== i
                  ? ((isSubFrame = !0),
                    (window.isSubFrame = !0),
          ...
          if (
            ...
            !window.failedOpenObj.isWideOpenMode())
          ) {
            0 == e.indexOf("www.") && (e = e.substr(4));
            var v = ENCRYPT(e),
              b = localStorage.getItem("NC:" + v);
            null != b && takeToFailedOpenBlockedPage(r, e, b);
          }
        }
      });
    try {
    ...
    d =
      (-1 != o.indexOf("google.c") &&
        -1 == o.indexOf("sites.google.com") &&
        -1 == o.indexOf("docs.google.com") &&
        -1 == o.indexOf("drive.google.com") &&
        -1 == o.indexOf("accounts.google.com") &&
        -1 == o.indexOf("calendar.google.com") &&
        -1 == o.indexOf("code.google.com")) ||
      -1 != o.indexOf("bing.com") ||
      -1 != o.indexOf("search.yahoo.c")
        ? "SS:0:-1:-1:-1:-1:-1"
        : "ALLOW:0:-1:-1:-1:-1:-1";
  }
  var h = d.split(":");
  return (
    (void 0 === h || null == h || h.length < 7) &&
      ((d = "ERROR:-1:-1:-1:-1:-1:-1"),
    ...
    (c.onerror = function () {
      ...
      (c.onload = function () {
        if (
          (setClearCacheCookie(),
          setClassroomCookies(),
          0 != (s = c.responseText.trim()).indexOf("FAILED_OPEN:"))
        ) {
          var n = s.split(":")[2];
          ...
          if (0 == isNaN(n) && n >= 0) {
            ...
            Long.fromNumber(i).and(Math.pow(2, 36)).shiftRight(0).toNumber() ==
              a && (r = !0);
          }
          if (-1 == s.indexOf("DENY") && 0 == skipCacheAndLogAlways(e, o))
            try {
              -1 == s.indexOf("WL_URL") ||
              (void 0 !== window.crextnBasegene_bit0 &&
                window.crextnBasegene_bit0 == window.bit0)
                ? (void 0 !== window.crextnBasegene_bit0 &&
                    window.crextnBasegene_bit0 == window.bit0) ||
                  sessionStorage.setItem(e, s)
                : sessionStorage.setItem(
                    window.atob(t).replace(/(^\w+:|^)\/\/|(www\.)/, ""),
                    s
                  ),
                0 == r &&
                  ((void 0 !== window.crextnBasegene_bit0 &&
...
function putURLCache(e, t, n, o) {
  ...
  (void 0 !== window.crextnBasegene_bit0 &&
    ...
    ? 0 != o ||
      (void 0 !== window.crextnBasegene_bit0 &&
        window.crextnBasegene_bit0 == window.bit0) ||
      sessionStorage.setItem(n, e + "," + new Date().getTime() / 1e3)
    : ((resultURL = window.atob(t).replace(/(^\w+:|^)\/\/|(www\.)/, "")),
      sessionStorage.setItem(resultURL, e + "," + new Date().getTime() / 1e3));
}
function findCrextnBasegene(e) {
  e.split(":").length >= 9 &&
    ((window.crextnBasegene = Long.fromString(e.split(":")[8], !0)
      .shiftRight(0)
      .toNumber()),
    (window.bit0 = Long.fromNumber(Math.pow(2, 0)).shiftRight(0).toNumber()),
    (window.crextnBasegene_bit0 = Long.fromNumber(window.crextnBasegene)
      .and(Math.pow(2, 0))
      .shiftRight(0)
      .toNumber()));
}
function setupListener() {
  chrome.tabs.onUpdated.addListener(function (e, t, n) {
    void 0 !== t.status && -1 != n.url.indexOf("blocked")
      ? "complete" != t.status
        ? -1 == n.url.indexOf("blocked") ||
          (-1 == n.url.indexOf("securly.com") &&
            -1 == n.url.indexOf("iheobagjkfklnlikgihanlhcddjoihkg")) ||
          (window.tabsBeingBlocked[e] = n.url)
        : delete window.tabsBeingBlocked[e]
      : void 0 !== t.status &&
        "complete" == t.status &&
        void 0 !== window.tabsBeingBlocked[e] &&
        chrome.tabs.update(
          e,
    ...
    chrome.webRequest.onErrorOccurred.addListener(
      function (e) {
        "net::ERR_ABORTED" == e.error &&
          "main_frame" == e.type &&
          -1 != e.url.indexOf("blocked") &&
          void 0 != typeof window.tabsBeingBlocked[e.tabId] &&
          chrome.tabs.update(
            e.tabId,
    ...
    chrome.webRequest.onBeforeSendHeaders.addListener(
      function (e) {
        ...
        if (
          ...
          if (
            -1 != (s = normalizeHostname(s)).indexOf("google.co") &&
          ...
          if (1 == o) {
            ...
            if (
              ...
              (-1 !== n.indexOf("youtube.") && !1 === window.checkYouTube) ||
                -1 === n.indexOf("youtube.") ||
                e.initiator !== window.refDomain)
            )
            ...
            var f = u[0],
              ...
              g = u[4];
            u[5], u[6];
            return this.iframeResp.length > 0 && "DENY" == this.iframeResp[0]
              ? ((this.iframeResp = ""), { cancel: !0 })
              : (-1 !== n.indexOf("youtube.") && "REFWL" == h
                  ? ((window.refDomain = e.initiator),
                    (window.checkYouTube = !1))
                  : -1 !== n.indexOf("youtube.") && (window.checkYouTube = !0),
                "GM" == f
                  ? (e.requestHeaders.push({
                      name: "X-GoogApps-Allowed-Domains",
                      value: g,
    ...
    chrome.idle.onStateChanged.addListener(function (e) {
      lastKnownState != e &&
        ("active" == e &&
          "idle" != lastKnownState &&
          (sessionStorage.clear(),
          window.featureConfig && 1 == window.featureConfig.reload_tabs
            ? rebrokerLoadedTabs()
            : chrome.windows.getAll({ populate: !0 }, function (e) {
                for (var t = 0; t < e.length; t++)
                  for (var n = 0; n < e[t].tabs.length; n++)
                    "chrome://" != e[t].tabs[n].url.substring(0, 9) &&
                      tabCheck.forEach(function (o) {
                        -1 !== e[t].tabs[n].url.indexOf(o) &&
                          chrome.tabs.reload(e[t].tabs[n].id, {
                            bypassCache: !0,
                          });
                      });
              })),
        ...
        : "think_twice" == e.name &&
          e.onMessage.addListener(function (t, n) {
            "fetchThinkTwice" == t.action
              ...
              : "sendThinkTwiceAnalytics" == t.action &&
...
function getYTOptions() {
  toSendUrl =
    ...
    "/broker?useremail=" +
    window.userEmail +
    "&reason=crextn&url=&ytoptions=true";
  ...
  e.onload = function () {
    ...
    (window.hideComments = "true" == t.split(":")[0]),
      ...
      (window.ytOptionsLastCheck = Math.floor(Date.now() / 1e3));
  };
  try {
    e.send();
  } catch (e) {
...
function onBeforeRequestListener(e, t = !1) {
  ...
  if (
    "main_frame" == e.type &&
    -1 == e.url.indexOf("securly") &&
    void 0 !== window.tabsBeingBlocked[e.tabId]
  )
  ...
  if (
    ...
    (window.youtubeLastCheck = null),
      n.indexOf("youtube") &&
        ...
        "UNKNOWN_SCHOOL" != window.clusterUrl &&
          "AVOID_OS" != window.clusterUrl &&
          (null == window.ytOptionsLastCheck ||
            Math.floor(Date.now() / 1e3) - window.ytOptionsLastCheck >= 3600) &&
          getYTOptions(),
        chrome.runtime.onConnect.addListener(function (t) {
          "yt" == t.name &&
            t.onMessage.addListener(function (o, r) {
              if (
                ...
                if (
                  ...
                  "unknown" != window.clusterUrl &&
                    "AVOID_OS" != window.clusterUrl &&
                    "UNKNOWN_SCHOOL" != window.clusterUrl &&
                    -1 === window.youtubeFrames.indexOf(t.sender.frameId) &&
                    (null != o.channelId ||
                      null != o.videoId ||
                      null != o.category))
                ) {
                  ...
                  "DENY" == f
                    ...
                    : this.iframeResp.length > 0 &&
                      "DENY" == this.iframeResp[0] &&
                      ((this.iframeResp = ""),
                      t.postMessage({
              ...
              } else "getYoutubeOptions" == o.action && t.postMessage({ hideRecommended: window.hideRecommended, hideComments: window.hideComments, hideSidebar: window.hideSidebar, hideThumbnails: window.hideThumbnails });
            });
        }),
        chrome.runtime.onConnect.addListener(function (e) {
          "gmaps" == e.name &&
            e.onMessage.addListener(function (e, t) {
              if (e.url != window.lastMapsUrl) {
                ...
                o.href = e.url;
                let r = getRespArrTabs(
                    (c = normalizeHostname((c = o.hostname.toLowerCase()))),
                    n,
                    "",
                    e.url,
                    t.sender.tab.id,
    ...
    if (
      (n.length > 1e3 && (n = n.substring(0, 1e3)),
      (a = getSocialPost(e, n)),
      -1 != n.indexOf("youtube.com") &&
        -1 != n.indexOf("youtubei/v1/search") &&
    ...
    if (
      ("SS" == h &&
        ((ssURL = takeSafeSearchAction(c, o)),
        !1 !== ssURL && (o = ssURL),
        (p = !0)),
      "CC" == g &&
        ((ccURL = takeCreativeCommonImageSearchAction(o)),
        !1 !== ccURL && (o = ccURL),
        (p = !0)),
      -1 !== n.indexOf("youtube.") && "REFWL" == g
        ? ((window.refDomain = e.initiator), (window.checkYouTube = !1))
        : -1 !== n.indexOf("youtube.") && (window.checkYouTube = !0),
      !0 === p)
    ) {
      ...
      if (-1 !== n.indexOf("google.")) {
        if (/q=/.test(n)) {
          if (
            -1 !== n.indexOf("google.") &&
            -1 === n.indexOf("safe=active") &&
            -1 === n.indexOf("safe=strict")
          )
            return { redirectUrl: o };
          if (!1 === ssURL && !1 === ccURL) return;
          if (
            -1 !== n.indexOf("google.") &&
            -1 !== n.indexOf("tbm=isch") &&
            -1 === n.indexOf("tbs=il:cl")
          )
            return { redirectUrl: o };
        }
      } else if (
        (-1 === n.indexOf("google.com") &&
          -1 !== n.indexOf("yahoo.com") &&
          -1 === n.indexOf("vm=r")) ||
        (-1 !== n.indexOf("bing.") && -1 === n.indexOf("adlt=strict"))
      )
        return { redirectUrl: o };
    }
  }
...
!(function (e, t) {
  ...
  return (
      ...
      var a = (i.MD5 = r.extend({
        ...
        _doProcessBlock: function (e, t) {
          ...
          (L = f(
            ...
            (R = f(
              R,
              (N = f(N, (B = f(B, L, R, N, g, 6, s[60])), L, R, O, 10, s[61])),
              B,
              L,
              h,
              15,
    ...
    (e.SHA1 = o._createHelper(i)),
    (e.HmacSHA1 = o._createHmacHelper(i)),
    (function (e) {
      var t = l,
        n = t.lib,
        o = n.WordArray,
            ...
            for (f = 0; f < 5; f++)
              for (g = 0; g < 5; g++) {
                var L = n[(_ = f + 5 * g)],
                  ...
                  N = u[((f + 1) % 5) + 5 * g],
                  U = u[((f + 2) % 5) + 5 * g];
                (L.high = R.high ^ (~N.high & U.high)),
                  (L.low = R.low ^ (~N.low & U.low));
              }
            L = n[0];
            var T = d[l];
          ...
          for (
            ...
            (z = P),
              ...
              (R =
                (ke +
                  (pe + we + (xe >>> 0 < me >>> 0 ? 1 : 0)) +
                  ((N = (ue + xe) | 0) >>> 0 < ue >>> 0 ? 1 : 0)) |
                0);
          }
          (w = o.low = w + N),
            (o.high = h + R + (w >>> 0 < N >>> 0 ? 1 : 0)),
            (p = r.low = p + T),
            (r.high = g + U + (p >>> 0 < T >>> 0 ? 1 : 0)),
            (v = i.low = v + A),
            (i.high = m + E + (v >>> 0 < A >>> 0 ? 1 : 0)),
            (y = s.low = y + D),
            (s.high = b + I + (y >>> 0 < D >>> 0 ? 1 : 0)),
            (O = l.low = O + H),
        ...
        var t = l,
          ...
          g =
            ((n.BlockCipher = d.extend({
              cfg: d.cfg.extend({ mode: h, padding: w }),
              reset: function () {
                var e;
                d.reset.call(this);
                var t = this.cfg,
          ...
          p = ((t.format = {}).OpenSSL = {
            stringify: function (e) {
              var t = e.ciphertext,
                n = e.salt;
              return (
                n ? r.create([1398893684, 1701076831]).concat(n).concat(t) : t
              ).toString(a);
            },
            parse: function (e) {
              var t,
          ...
          v = ((t.kdf = {}).OpenSSL = {
            execute: function (e, t, n, o) {
              ...
              return (i.sigBytes = 4 * t), g.create({ key: i, iv: s, salt: o });
            },
          }),
          b = (n.PasswordBasedCipher = m.extend({
            cfg: m.cfg.extend({ kdf: v }),
            encrypt: function (e, t, n, o) {
              var r = (o = this.cfg.extend(o)).kdf.execute(
                n,
                e.keySize,
                e.ivSize
              );
    ...
    (l.pad.Iso10126 = {
      pad: function (e, t) {
        var n = 4 * t,
          o = n - (e.sigBytes % n);
        e.concat(l.lib.WordArray.random(o - 1)).concat(
          l.lib.WordArray.create([o << 24], 1)
        );
      },
      unpad: function (e) {
        var t = 255 & e.words[(e.sigBytes - 1) >>> 2];
      ...
      var e = l,
        ...
        u = (r.DES = o.extend({
          ...
          _doCryptBlock: function (e, t, n) {
            ...
            for (var o = 0; o < 16; o++) {
              for (
                var r = n[o], i = this._lBlock, s = this._rBlock, a = 0, l = 0;
                l < 8;
                l++
              )
                a |= c[l][((s ^ r[l]) & d[l]) >>> 0];
    ...
    (function () {
      ...
      function r() {
        for (
          var e = this._S, t = this._i, n = this._j, o = 0, r = 0;
          r < 4;
          r++
        ) {
          n = (n + e[(t = (t + 1) % 256)]) % 256;
          ...
          !(function (o) {
            ...
            (r.fromInt = function (e, t) {
              ...
              (r.fromNumber = function (e, t) {
                return (
                  ...
                  isNaN(e) || !isFinite(e)
                    ...
                    ? r.MAX_VALUE
                    : t && c <= e
                    ? r.MAX_UNSIGNED_VALUE
                    : e < 0
                    ? r.fromNumber(-e, t).negate()
                    : new r(e % a | 0, (e / a) | 0, t)
                );
              }),
              ...
              (r.fromString = function (e, t, n) {
                ...
                for (
                  var i = r.fromNumber(Math.pow(n, 8)), s = r.ZERO, a = 0;
                  a < e.length;
                  a += 8
                ) {
            ...
            var a = 4294967296,
              ...
              d = r.fromInt(1 << 24);
            (r.ZERO = r.fromInt(0)),
              (r.UZERO = r.fromInt(0, !0)),
              (r.ONE = r.fromInt(1)),
              (r.UONE = r.fromInt(1, !0)),
              (r.NEG_ONE = r.fromInt(-1)),
              (r.MAX_VALUE = r.fromBits(-1, 2147483647, !1)),
              (r.MAX_UNSIGNED_VALUE = r.fromBits(-1, -1, !0)),
              (r.MIN_VALUE = r.fromBits(0, -2147483648, !1)),
                ...
                if (this.isNegative()) {
                  if (this.equals(r.MIN_VALUE)) {
                    ...
                    return (
                      ...
                      o.toString(e) + t.toInt().toString(e)
                    );
                  }
              ...
              (r.prototype.getNumBitsAbs = function () {
                if (this.isNegative())
                  return this.equals(r.MIN_VALUE)
                    ? 64
              ...
              (r.prototype.lessThanOrEqual = function (e) {
                return (
                  r.isLong(e) || (e = r.fromValue(e)), this.compare(e) <= 0
                );
              }),
              ...
              (r.prototype.negate = function () {
                return !this.unsigned && this.equals(r.MIN_VALUE)
                  ? r.MIN_VALUE
                  : this.not().add(r.ONE);
              }),
              ...
              (r.prototype.subtract = function (e) {
                return (
                  r.isLong(e) || (e = r.fromValue(e)), this.add(e.negate())
                );
              }),
              ...
              (r.prototype.div = function (e) {
                ...
                var t, n, o;
                if (this.equals(r.MIN_VALUE))
                  return e.equals(r.ONE) || e.equals(r.NEG_ONE)
                    ? r.MIN_VALUE
                    : e.equals(r.MIN_VALUE)
                    ? r.ONE
              ...
              (r.prototype.shiftLeft = function (e) {
                return (
                  ...
                  0 == (e &= 63)
                    ...
                    : r.fromBits(0, this.low << (e - 32), this.unsigned)
                );
              }),
  ...
  chrome.downloads.onCreated.addListener(function (e) {
    ...
    if ("text/html" == e.mime) {
      ...
      if ("DENY" == getRespArr((r = normalizeHostname(r)), n, "", t)[0])
        return (
          chrome.downloads.cancel(e.id), void chrome.downloads.removeFile(e.id)
        );
    }
  });
var previousMeetUrl = "";
...
class FailedOpen {
  constructor(e, t) {
    (this.wideOpenMode = 0),
      ...
      (this.mode = e),
      (this.duration = t),
      (void 0 !== this.mode && null != this.mode && -1 != this.mode) ||
        (this.mode = 1),
      (void 0 !== this.duration &&
        null != this.duration &&
        -1 != this.duration) ||
        (this.duration = 300),
      (this.timeStamp = Math.floor(Date.now() / 1e3));
  }
  isFailedOpen() {
  ...
  if (window.vectorExpansionRules) {
    ...
    if (0 != t.length) {
      ...
      if (
        ...
        t && -1 != t.indexOf(mainHost))
      )
        for (
          let t = 0;
          t < window.vectorExpansionRules[mainHost].length;
          t += 1
        )
          try {
            ...
            if (c.test(e.url)) {
              if ("JSON_STR" == s) {
                let n = window.vectorExpansionRules[mainHost][t].data
                  .split("|")
                  .reduce((e, t) => e[t], e);
                if (((jsonInfo = JSON.parse(n)), Array.isArray(i)))
                  for (let e = 0; e < i.length; e += 1)
                    (tempText = removeHTMLTags(
                      i[e].split("|").reduce((e, t) => e[t], jsonInfo)
                    )),
                      (l = l.length > 0 ? l + " " + tempText : tempText);
                else
                  l = removeHTMLTags(
                    i.split("|").reduce((e, t) => e[t], jsonInfo)
                  );
              } else if ("ENCODED_STR" == s) {
                if (
                  ((buff = e.requestBody.raw[0].bytes),
                  (postContent = buff2Str(buff)),
                  Array.isArray(i))
                )
                  for (let e = 0; e < i.length; e += 1)
                    (tempText = i[e]
                      .split("|")
                      .reduce(
                        (e, t) => new URLSearchParams(e).get(t),
                        postContent
                      )),
                      (l = l.length > 0 ? l + " " + tempText : tempText);
                else
                ...
                l =
                  "reddit.com" == mainHost
                    ? removeHTMLTags(fetchStringFromJSONObj(JSON.parse(l), "t"))
                    : removeHTMLTags(l);
              } else if ("ENCODED" == s) {
                ...
                if (Array.isArray(i))
                  for (let e = 0; e < i.length; e += 1)
                    "tumblr.com" == mainHost && "content" == i[e]
                      ? (tempText = removeHTMLTags(
                          fetchStringFromJSONObj(t, "text")
                        ))
                      : (tempText = removeHTMLTags(
                          i[e].split("|").reduce((e, t) => e[t], t)
                        )),
                      (l = l.length > 0 ? l + " " + tempText : tempText);
                ...
                if (
                  ...
                  (t &&
                    t.queryName &&
                    -1 != t.queryName.indexOf("answerCreate") &&
                    (r = "ANSWER"),
                  t &&
                    t.queryName &&
                    -1 != t.queryName.toLowerCase().indexOf("draft"))
                )
                  continue;
                if (n.length > 0) {
                ...
                for (let t = 0; t < i.length; t += 1)
                  (tempText = removeHTMLTags(
                    ...
                    "reddit.com" == mainHost &&
                      -1 != i[t].indexOf("richtext_json") &&
                      tempText.length > 0 &&
                      ((textStr = removeHTMLTags(
                        fetchStringFromJSONObj(JSON.parse(tempText), "t")
                      )),
                      (captionStr = removeHTMLTags(
                        fetchStringFromJSONObj(JSON.parse(tempText), "c")
                      )),
...
!(function () {
  var e,
    ...
    r = function () {
      ...
      return new Promise(function (t, n) {
        chrome.cookies.getAll({ domain: e, name: "wpwResponse" }, function (e) {
          e && e.length > 0 ? t(!0) : t(!1);
        });
      });
    };
  chrome.runtime.onMessage.addListener((i, s) => {
    console.debug("wpw msg received", i, s),
      "object" == typeof i &&
        void 0 !== i.action &&
        void 0 !== i.source &&
        void 0 !== s.tab.id &&
          ...
          (async function (e) {
            if ("notloggedin" != userEmail)
              try {
                ...
                if (t - o <= 1800) return;
                var s = createNonBlockingRequest(
                  "get",
                  window.clusterUrl +
                    "/wellnessPathwaysWidgets?action=getWidget"
                );
                (s.onerror = function () {
        ...
        ("ctaClicked" != i.action && "closed" != i.action) ||
          ((e = [new Date().getTime()].join(":")),
          (t = new URL(window.clusterUrl).host),
          chrome.cookies.set({
            domain: t,
            url: "https://" + t + "/",
            path: "/",
          ...
          (function (e) {
            try {
              ...
              "ctaClicked" == e.action &&
                ((t.ctaLabel = e.label), (t.ctaLink = e.link));
              var n = createNonBlockingRequest(
                "post",
                window.clusterUrl + "/wellnessPathwaysWidgets"
              );
              n.setRequestHeader("Content-Type", "application/json"),
                ...
                (n.onload = function () {
                  JSON.parse(n.responseText).success &&
  ...
  (window.userStatus = { NOTFOUND: -1, FOUND: 1 }),
