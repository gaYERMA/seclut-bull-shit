!(function (e, t) {
  ...
  (b.filter = function (e, t, n) {
    ...
    b.fn.extend({
      ...
      is: function (e) {
        return !!D(this, "string" == typeof e && E.test(e) ? b(e) : e || [], !1)
          .length;
      },
    });
  var N,
    ...
    b.extend({
      ...
      ready: function (e) {
        (!0 === e ? --b.readyWait : b.isReady) ||
          ((b.isReady = !0),
          (!0 !== e && --b.readyWait > 0) || F.resolveWith(v, [b]));
      },
    }),
    (b.ready.then = F.then),
  ...
  function xe(e, t, n, r, i) {
    ...
    for (f.textContent = "", d = 0; (o = p[d++]); )
      if (r && b.inArray(o, r) > -1) i && i.push(o);
        ...
        ((l = re(o)), (a = ve(f.appendChild(o), "script")), l && me(a), n)
      )
  ...
  function He(e, t, n, r) {
    ...
    var i,
      ...
      v = t[0],
      m = h(v);
    if (m || (p > 1 && "string" == typeof v && !d.checkClone && ke.test(v)))
    ...
    if (
      ...
      for (u = (s = b.map(ve(i, "script"), je)).length; f < p; f++)
        (l = i),
          f !== g &&
          ...
          (l = s[f]),
            he.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : y(l.textContent.replace(De, ""), l, c));
    }
    return e;
  }
  function Oe(e, t, n) {
  ...
  b.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        (a = ve(c, "script")).length > 0 && me(a, !f && ve(e, "script")), c
      );
    },
  ...
  b.extend(b.event, {
    trigger: function (t, n, r, i) {
      ...
      if (
        ...
        if (!i && !p.noBubble && !g(r)) {
          for (
            u = p.delegateType || y, vt.test(u + y) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            m.push(a), (s = a);
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = r[l]) && (r[l] = null),
              (b.event.triggered = y),
              t.isPropagationStopped() && d.addEventListener(y, mt),
              r[y](),
              t.isPropagationStopped() && d.removeEventListener(y, mt),
      ...
      ajax: function (t, n) {
        ...
        function E(t, n, a, u) {
          ...
          l ||
            ...
            f
              ? (d.ifModified &&
                  ((T = S.getResponseHeader("Last-Modified")) &&
                    (b.lastModified[i] = T),
                  (T = S.getResponseHeader("etag")) && (b.etag[i] = T)),
                204 === t || "HEAD" === d.type
                  ? (C = "nocontent")
                  : 304 === t
                  ? (C = "notmodified")
            ...
            (S.status = t),
            (S.statusText = (n || C) + ""),
            f ? m.resolveWith(h, [p, C, S]) : m.rejectWith(h, [S, C, v]),
            S.statusCode(x),
            (x = void 0),
  ...
  b.ajaxSetup({
        ...
        return (
          ...
          r.always(function () {
            void 0 === o ? b(e).removeProp(i) : (e[i] = o),
              t[i] && ((t.jsonpCallback = n.jsonpCallback), Bt.push(i)),
              a && h(o) && o(a[0]),
              (a = o = void 0);
          }),
          "script"
    ...
    b.each(["top", "left"], function (e, t) {
      b.cssHooks[t] = We(d.pixelPosition, function (e, n) {
        if (n)
          return (n = Fe(e, t)), Pe.test(n) ? b(e).position()[t] + "px" : n;
      });
    }),
...
var FuzzySet = (function () {
  ...
  return function (e, t, n, r) {
    ...
    (e = e || []),
      (i.gramSizeLower = n || 2),
      (i.gramSizeUpper = r || 3),
      (i.useLevenshtein = "boolean" != typeof t || t),
      (i.exactSet = {}),
      (i.matchDict = {}),
      (i.items = {});
    var o = function (e, t) {
        ...
        var n = (function (e, t) {
          for (var n, r, i = [], o = 0; o <= t.length; o++)
            for (var a = 0; a <= e.length; a++)
              (r =
                o && a
                  ? e.charAt(a - 1) === t.charAt(o - 1)
                    ? n
                    : Math.min(i[a], i[a - 1], n) + 1
                  : o + a),
                (n = i[a]),
                (i[a] = r);
          return i.pop();
    ...
    (i.get = function (e, t, n) {
      ...
      (i.__get = function (e, t, n) {
        ...
        if ((v.sort(y), this.useLevenshtein)) {
          for (var x = [], b = Math.min(50, v.length), w = 0; w < b; ++w)
            x.push([o(v[w][1], l), v[w][1]]);
          (v = x).sort(y);
        }
        return (
          (x = []),
      ...
      (i._add = function (e, t) {
        ...
        for (o in u)
          (a = u[o]),
            (l += Math.pow(a, 2)),
            o in this.matchDict
              ? this.matchDict[o].push([i, a])
              : (this.matchDict[o] = [[i, a]]);
        var c = Math.sqrt(l);
