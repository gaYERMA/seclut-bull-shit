...
function onWindowLoad() {
  ...
  (new MutationObserver(function (e) {
    e.some(function (e) {
      ...
      if (
        (t = (t = t.replace(/^\([0-9]{0,}\)\s/, "")).replace(/ +/g, " ")) != n
      )
        return (
          (n = t),
  ...
  }).observe(t, { subtree: !0, characterData: !0, childList: !0 }),
  null != document.querySelector("ytd-browse")) &&
    ((window.ytdBrowse = document.querySelector("ytd-browse")),
    (window.lastUpdateBrowse = null),
    new MutationObserver(function (e) {
      e.some(function () {
        if (
          null == window.lastUpdateBrowse ||
          Math.floor(Date.now() / 1e3) - window.lastUpdateBrowse > 5
        ) {
          return (
            (window.lastUpdateBrowse = Math.floor(Date.now() / 1e3)),
            sendData(fetchPageInfo(!1)),
    ...
    }).observe(ytdBrowse, { subtree: !0, characterData: !0, childList: !0 }));
}
function fetchPageInfo(e, n = "") {
  if (e) {
    ...
    return { channelId: t, videoId: o, category: d, embedded: l };
  }
  if (
    !1 === e &&
    null != document.querySelector("meta[itemprop='channelId']")
  ) {
    return {
      channelId: document
...
function hideComment() {
  null !== document.querySelector("ytd-comments") &&
...
function hideSidebar() {
  null !== document.querySelector("div[id='related']") &&
